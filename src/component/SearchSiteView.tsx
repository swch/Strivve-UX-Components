...
function SelectSiteView({ options, core, appearance }: BaseProps & mountSelectSiteViewProps) {
  ...
  return (
    <div data-testid="modal" className='modal' css={appearance.elements?.modal}>
      <div data-testid="searchSiteView" className='searchSiteView' css={appearance.elements?.searchSiteView}>
        <div className='searchSiteHeader' css={appearance?.elements?.searchSiteHeader}>
          <AccountInput
            label='Search site'
            name='search'
