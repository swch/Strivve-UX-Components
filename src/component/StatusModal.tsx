      ...
      <div className='modalStatus' css={appearance.elements?.modalStatus}>
        ...
        >
          <svg width="12" height="13" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <line x1="16.3536" y1="1.35355" x2="0.353554" y2="17.3536" stroke="black" />
          </svg>
        </div>
        {
          variant === 'success' && (
            <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M25.2442 12.601L15.7261 21.9323L11.2471 17.5411" stroke="#6BBF00" />
            </svg>
          )
        }

        {
          variant === 'error' && (
            <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="25.8536" y1="9.35355" x2="10.8536" y2="24.3536" stroke="#FF0000" />
              <line x1="26.1464" y1="24.3536" x2="11.1464" y2="9.35355" stroke="#FF0000" />
